...
import SidebarSolicitante from "./SidebarSolicitante";
import HeaderSolicitante from "./HeaderSolicitante";

export default function SolicitanteLayout({ children, title }) {
