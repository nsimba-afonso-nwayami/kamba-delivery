...
import { solicitanteSchema } from "../../validations/solicitanteSchema";
...
export default function CompleteSolicitante() {
  ...
  const {
    ...
    resolver: yupResolver(solicitanteSchema),
  });

  // arquivo handler (SEM MEXER NO UI)
                ...
                {!biFrentePreview ? (
                  ...
                  <div className="relative h-32 w-full">
                    ...
                    <button
                      ...
                      className="absolute -top-2 -right-2 bg-red-700 text-white w-7 h-7 rounded-full flex items-center justify-center shadow-md hover:bg-red-900"
                    >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  {...register("morada")}
                  type="text"
                  placeholder="Província, Município, Bairro e Rua"
                  className="w-full pl-11 pr-4 py-4 border border-gray-200 rounded-xl bg-gray-50/50 focus:border-red-700 outline-none transition-all font-medium"
                />
              </div>
